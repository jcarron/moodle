...
class backup_enhancedchoice_activity_structure_step extends backup_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        $option->set_source_table('enhancedchoice_options', array('enhancedchoiceid' => backup::VAR_PARENTID), 'id ASC');

        // All the rest of elements only happen if we are including user info
        if ($userinfo) {
            $answer->set_source_table('enhancedchoice_answers', array('enhancedchoiceid' => '../../id'));
        }
        ...
        // Return the root element (enhancedchoice), wrapped into standard activity structure
