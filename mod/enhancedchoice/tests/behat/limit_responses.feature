...
Feature: Limit enhancedchoice responses
  In order to restrict students from selecting a response more than a specified number of times
  As a teacher
  I need to limit the enhancedchoice responses

  Scenario: Limit the number of responses allowed for a enhancedchoice activity and verify the result as students
