...
Feature: Teacher can modify enhancedchoices of the students
  In order to have all students enhancedchoices
  As a teacher
  I need to be able to make enhancedchoice for studnets
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | enhancedchoice   | EnhancedChoice name | Test enhancedchoice description | C1     | enhancedchoice1  | Option 1, Option 2, Option 3 |

  @javascript
  Scenario: Delete students enhancedchoice response as a teacher
  ...
  @javascript
  Scenario: Teacher can delete answers in the multiple answer enhancedchoice
    And I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I follow "EnhancedChoice name"
    And I navigate to "Edit settings" in current page administration
    And I set the field "Allow more than one enhancedchoice to be selected" to "Yes"
    And I press "Save and return to course"
    And I log out
    And I log in as "student1"
    And I am on "Course 1" course homepage
