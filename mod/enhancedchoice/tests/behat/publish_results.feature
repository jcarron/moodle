...
Feature: A teacher can choose one of 4 options for publishing enhancedchoice results
  In order to display enhancedchoice activities outcomes
  As a teacher
  I need to publish the enhancedchoice activity results in different ways
  ...
  Scenario: Do not publish results to students
    ...
    When I choose "Option 1" from "EnhancedChoice 1" enhancedchoice activity
  ...
  Scenario: Show results to students after they answer
    ...
    And I am on "Course 1" course homepage
    And I choose "Option 1" from "EnhancedChoice 1" enhancedchoice activity
    And I should see "Your selection: Option 1"
    And I should see "Responses"

  Scenario: Show results to students only after the enhancedchoice is closed
    Given I add a "EnhancedChoice" to section "1" and I fill the form with:
      | EnhancedChoice name | EnhancedChoice 1 |
      | Description | EnhancedChoice Description |
