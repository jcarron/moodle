...
class duallang_string_manager extends \core_string_manager_standard
{
     ...
     *            the identifier of the string to search for
     * @param string $component
     *            the component the string is provided by
     * @param string|object|array $a
     *            optional data placeholder
     * @param string $lang
     *            moodle translation language, null means use current
     * @return string
     */
    public function get_string($identifier, $component = '', $a = null, $lang = null)
    {
        $string = ''; // returns an empty string by default
        if (get_config('local_duallang', 'enabled') == "1") {
